...
public class Mario extends GameObject
{
    ...
    int LevelNumber = 14 ;
    public int PlayerX = 3, PlayerY = 6;
    ...
    {
        super(aThis) ;
		System.out.println("+ Mario::Mario::Mario()");

        CurrentCheckpoint = CP ;
        
        LevelNumber = CurrentCheckpoint.GetNextLevel();
        
        PlayerX = CurrentCheckpoint.NextLocation.x * 32;
    ...
    {
		System.out.println("+ Mario::Mario::initResources()");
...
//            EnemyGroup.add(new Enemy(34*32, 10*32 , this.bsLoader.getStoredImages("turtle") , "turtle" , this ) );
            ...
            AnimationGroup    = new SpriteGroup("AnimationGroup"   ); // specially made to render animations on top of all spritegroup
            ...
            for ( int i = 0; i < Tiles; i++ )
            {
                ...
                if      ( CurrentLevel.BackGroundImage.equals("Mountain"   ) ) { BackGroundSpriteGroup.add( new Sprite( this.getImage("Mountain.png"   ), 1536 * i, 32 ) ); }
                else if ( CurrentLevel.BackGroundImage.equals("Clouds"     ) ) { BackGroundSpriteGroup.add( new Sprite( this.getImage("Clouds.png"     ), 1536 * i, 32 ) ); }
                else if ( CurrentLevel.BackGroundImage.equals("CloudsNight") ) { BackGroundSpriteGroup.add( new Sprite( this.getImage("CloudsNight.png"), 1536 * i, 32 ) ); }
                else if ( CurrentLevel.BackGroundImage.equals("Fence"      ) ) { BackGroundSpriteGroup.add( new Sprite( this.getImage("Fence.png"      ), 1536 * i, 32 ) ); }
                else if ( CurrentLevel.BackGroundImage.equals("Fence2"     ) ) { BackGroundSpriteGroup.add( new Sprite( this.getImage("Fence2.png"     ), 1536 * i, 32 ) ); }
            }
            
            // sea
            if ( CurrentLevel.attribute.equals("Sea") )
            {
            	for ( int i = 0; i < CurrentLevel.LevelLength/32; i++ ) { BackGroundSpriteGroup.add( new Sprite( this.getImage("Sea.png"), 32 * i, 0) ); }
            }
            ...
            // Background Color
            if      ( CurrentLevel.BackGroundColor.equals("Blue"    ) ) { color_background = new ColorBackground( this.BackGroundColor,   CurrentLevel.LevelLength, 480 ); }
            else if ( CurrentLevel.BackGroundColor.equals("Black"   ) ) { color_background = new ColorBackground( Color.BLACK,            CurrentLevel.LevelLength, 480 ); }
            else if ( CurrentLevel.BackGroundColor.equals("DarkBlue") ) { color_background = new ColorBackground( new Color(32, 56, 236), CurrentLevel.LevelLength, 480 ); }
            else                                                        { color_background = new ColorBackground( Color.GREEN,            CurrentLevel.LevelLength, 480 ); }
            ...
            player = new Player( PlayerX, PlayerY, this.bsLoader.getStoredImages("player"), this );
            ...
            if ( "Sea".equals(CurrentLevel.attribute) ) { this.player.Water = true; }
...
//        player.Grow();
        ...
        else { this.playMusic("music/"+this.CurrentLevel.attribute+".mp3"); }
    }

	public void update( long l )
	{
		System.out.println("+ Mario::Mario::update()");

		// start screen
		if ( this.LevelNumber == 10 )
		{
			if ( this.bsInput.isKeyPressed( KeyEvent.VK_Z ) ) { IncreaseWorld(); }
			if ( this.bsInput.isKeyPressed( KeyEvent.VK_X ) ) { IncreaseLevel(); }
...
//                 System.out.println("bomb");
        ...
        if ( player.getY() > 500 ) { this.Restart(); }
        
        if ( this.bsInput.isKeyDown( KeyEvent.VK_RIGHT ) ) { player.GoToRight(); }
        else { player.KeyPressedRight = false ; }
        if ( this.bsInput.isKeyDown( KeyEvent.VK_LEFT ) ) { player.GoToLeft(); }
        if ( this.bsInput.isKeyDown( KeyEvent.VK_DOWN ) ) { player.Down(); }
        else { player.KeyPressedDown = false; }
        if ( this.bsInput.isKeyDown( KeyEvent.VK_UP ) ) { player.Up(); }
        if ( this.bsInput.isKeyPressed( KeyEvent.VK_Z ) ) { player.Fire(); }
        if ( this.bsInput.isKeyDown( KeyEvent.VK_Z ) ) { player.Speed(true); }
        else { player.Speed(false);}
        if ( this.bsInput.isKeyDown( KeyEvent.VK_X ) ) {
            if ( !player.Water ) { player.Jump(); }
        }
        if ( this.bsInput.isKeyPressed( KeyEvent.VK_X ) ) {
            if ( player.Water ) { player.Jump(); }
        }
        if ( this.bsInput.isKeyPressed( KeyEvent.VK_R ) ) { player.setX(172*32); }
        //================================== player Controls END ====================================
...
//        VolitileGroup.update(l); 
    ...
    {
		System.out.println("+ Mario::Mario::render()");
	         ...
	         else
	         {
	        	 ...
	        	 for ( int i = 0; i < playfield.getGroups().length; i++ )
	        	 {
	        		 if ( playfield.getGroups()[i] != PlayerGroup ) { // render
	        				System.out.println("+ Mario::Mario::render() --- SpriteGroup: " + playfield.getGroups()[i].getName() );
...
//       g.drawString("degree :" +degree , 100,100 );
    ...
    {
		System.out.println("+ Mario::Mario::LoadLevel()");
...
//                                         this.EnemyGroup.add(new plant(this.bsLoader.getStoredImages("plant.png") ,(constr.getX()*32)+ (x*32)+16,  (constr.getY()*32)+ (y*32)+48 , this ));
    ...
    private BasicLevel SelectLevel( int levelNumber )
    {
		System.out.println("+ Mario::Mario::SelectLevel() --- levelNumber: " + levelNumber );
    ...
    {
		System.out.println("+ Mario::Mario::FindDublicates()");
    ...
    {
		System.out.println("+ Mario::Mario::RemoveBridge()");
...
//        this.pauseEnemys();
    ...
    {
		System.out.println("+ Mario::Mario::LoadCheckPoints()");
...
//                    else 
    ...
    {
		System.out.println("+ Mario::Mario::LoadTeleport()");
    ...
    public void LevelComplete(Sprite checkpoint) {
		System.out.println("+ Mario::Mario::LevelComplete()");
        LevelComplete = true ;
        cp  = (CheckPoints) checkpoint ;
    }

    public void LoadNextCheckPoint() {
		System.out.println("+ Mario::Mario::LoadNextCheckPoint()");
        parent.nextGameID = cp ;
        this.finish();
    }
    ...
    {
		System.out.println("+ Mario::Mario::MarioGoingDownAnimation()");
...
//        ani.setAnimationTimer(new Timer(200));
    ...
    {
		System.out.println("+ Mario::Mario::MarioGoingInsidePumpToRight()");
	...
	public void Restart()
	{
		System.out.println("+ Mario::Mario::Restart()");
    ...
    {
		System.out.println("+ Mario::Mario::DrawScore()");
...
//        font.drawString(g ,"X  "+(int)player.getX()/32 + " Y "+(int)player.getY()/32, 21, 64 );
    ...
    {
		System.out.println("+ Mario::Mario::LoadInvisibleObjects()");
