...
public abstract class Game {
	...
	{
		System.out.println("+ Mario::Game::start()");
	...
	{
		System.out.println("+ Mario::Game::initialize()");
	...
	void startGameLoop()
	{
		System.out.println("+ Mario::Game::startGameLoop()");
	 ...
	 */
	protected void initEngine() {
		System.out.println("+ Mario::Game::initEngine()");
